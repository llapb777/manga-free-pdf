...
async function renderBanner() {
	if (bannerData && bannerData.visible === true) {
		...
		banner.innerHTML += `<h3 style="color: ${bannerData.titleTextColor};${bannerData.sideTitleText}: 0.5rem;max-width: ${bannerData.titleWithTitle}" class="banner__text">${bannerData.text}</h3>`
